export class ModalView {
 ...
 getInputValue() {
  return $('#lista').val() || $('#itemNome').val();
 }
 setInputValue(value) {
  $('#lista, #itemNome').val(value);
 }
 ...
 createContentInModal(nomeAtual = '') {
  ...
  this.modalContent.html(`
      ...
      <div class='modal_footer'><button id="saveList" class="btn btn--primary" disabled>Salvar</button></div>
    `);
 }
 ...
 createItemContent({ name = '', price = '', amount = '' } = {}) {
  ...
  this.modalContent.html(`
    ...
    <div class='modal_footer'>
      <button id="saveItem" class="btn btn--primary" disabled>Salvar</button>
    </div>
  `);
 }
 getItemFormValues() {
